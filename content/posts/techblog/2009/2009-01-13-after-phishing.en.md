...
description: Steps to take after falling for a phishing scam — updated from the 2009 guide that referenced Internet Explorer 8 SmartScreen and Microsoft Update.
layout: single
author_profile: true
...
* In the United States, report identity theft at [IdentityTheft.gov](https://www.identitytheft.gov/) and file a fraud report at [ReportFraud.ftc.gov](https://reportfraud.ftc.gov/).

    You can also report the phishing scam to the [Anti-Phishing Working Group](https://apwg.org/) by forwarding the phishing e-mail message as an attachment to [reportphishing@apwg.org](mailto:reportphishing@apwg.org).
...
* Read [How to create and use strong passwords](/2009/01/13/passwords/).
...
* Keep Windows patched — see [Check for Windows Updates](/2009/01/13/check-for-windows-updates/).
