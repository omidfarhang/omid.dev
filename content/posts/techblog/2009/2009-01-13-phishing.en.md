...
For more detail on spotting fraudulent messages, see [How to recognize phishing e-mails or links](/2009/01/13/phishing-emails/).
...
Report the attempt by forwarding the message as an attachment to [abuse@outlook.com](mailto:abuse@outlook.com). Do not click any links or open attachments in the original message.
...
For the full recovery checklist, see [What to do if you've responded to a phishing scam](/2009/01/13/what-to-do-if-youve-responded-to-a-phishing-scam/).
