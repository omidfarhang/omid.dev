...
1. **Never open pictures, download files, or click links in messages from people you don't know.** If they come from someone you do know, confirm with the sender that the message (and its attachments) is trustworthy. If it's not, close the conversation.

2. **Be careful when you create a screen name or username.** Each messaging app asks you to pick a handle. Your username should not provide or allude to personal information. For example, use a nickname such as FootballFan instead of BaltimoreJenny.

3. **Create a barrier against unwanted instant messaging.** Do not list your screen name or phone number in public areas (such as large Internet directories or online community profiles) or give them to strangers.
...
5. **Block unwanted messages.** Most messaging apps allow you to build a contact list (also known as a "buddy list" or "friends list"), which is similar to the address book in your e-mail program.
...
9. **Monitor and limit your children's use of IM.** On Windows, use **Microsoft Family Safety** (Settings → Accounts → Family). On macOS, use **Screen Time** parental controls. On mobile, use the built-in parental controls in iOS and Android, or a dedicated app.
