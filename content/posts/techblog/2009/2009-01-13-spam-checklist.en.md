...
description: A do/don't checklist for reducing spam and phishing risk — updated from the 2009 version that recommended Symantec Brightmail.
layout: single
author_profile: true
...
* For organizations, use a reputable e-mail security gateway (Microsoft Defender for Office 365, Google Workspace spam filtering, or a dedicated provider such as Proofpoint or Mimecast) to filter spam before it reaches inboxes.
* Keep up to date on recent spam trends — the [Anti-Phishing Working Group](https://apwg.org/) publishes quarterly reports on phishing and spam activity.
