...
1. Download and Burn [Avira Rescue System](https://support.avira.com/hc/en-us/articles/360007776058-Creating-and-using-Avira-Rescue-System) to a blank Disc, Boot your computer using that and let it scan and remove malwares detected.
2. Restart your computer into safe-mode with networking. ([How to use Safe Mode](https://neosmart.net/wiki/safe-mode/)?)
3. Clean temporary files using [TFC](/2009/01/13/tfc/). _\[Let it reboot your computer, come back to Safe Mode With Networking\]_
4. Download [HitmanPro](https://www.hitmanpro.com/) to your desktop, run it in force breach mode and click next to scan your computer, let it remove the malwares it find, if it ask you for license active the 30 Days trial version. after removal, restart your computer. _\[Try it in Safe Mode With Networking\]_
5. Download, install and update [Malwarebytes Antimalware](https://www.malwarebytes.com/mwb-download), let it scan your computer and remove everything it find _\[Try in Safe Mode With Networking\]_.
6. Download and run [avast! Browser Cleanup](https://www.avast.com/c-browser-cleaner-tool) to cleanup and reset your browsers.
7. Download and install [HostsMan](https://www.abelhadigital.com/hostsman/).  
...
8. Disable System Restore and then re-enable it again.
...
10. Make sure your windows and all installed programs are fully updated and there are no insecure program: [Check for Update](/2009/01/13/check-for-windows-updates/).
