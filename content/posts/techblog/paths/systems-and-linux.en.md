...
4. **[The HDMI Port Was Keeping NVIDIA Awake](/2026/08/23/hdmi-port-keeping-nvidia-awake/)** — Hybrid PRIME is fine; native HDMI can still keep the dGPU in the display path. USB-C/TB4 DisplayPort puts the monitor on Intel.

## Tools and setup

5. **[How to Install Cursor IDE on Manjaro](/2026/05/29/how-to-install-cursor-ide-in-manjaro/)** — Practical setup notes for a modern editor on Arch-based distros.
6. **[A Maintainable Command-Line Workspace on Linux](/2026/08/03/a-maintainable-command-line-workspace-on-linux/)** — A reproducible terminal, shell, multiplexer, and dotfiles foundation that works across machines and distros.
7. **[How to Stretch Cursor Pro Further: A Split AI Workflow](/2026/06/29/how-to-stretch-cursor-pro-with-a-split-ai-workflow/)** — After install: split work across ChatGPT, Claude, Ollama, and Cursor; quota mechanics and local model picks on Linux.
